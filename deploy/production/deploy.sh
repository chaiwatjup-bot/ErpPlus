#!/bin/bash
# ============================================================
#  ErpPlus - Production Deployment Script
#  Domain: tplusoneleasing.com
#  Server: GCP VM Instance (Ubuntu 24.04 LTS)
#  Spec  : e2-medium (2 vCPU, 4GB RAM), 50GB SSD
# ============================================================
...
# Set root password (skip if already set)
...
# 8. Create Site
# -----------------------------------------------
echo "[8/10] Creating production site..."
...
# -----------------------------------------------
echo "[9/10] Setting up production..."
...
echo ""
echo "========================================"
echo "  ErpPlus Production Deploy Complete!"
echo "========================================"
echo ""
